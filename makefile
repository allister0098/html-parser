...
html.out: html-driver.o html-parser.o html-scanner.o html.o node.o comment.o document.o
	g++ --std=c++11 -o html.out html-driver.o html-parser.o html-scanner.o html.o node.o  comment.o document.o
...
html-parser.cc html-parser.hh: html-parser.yy
	bison --defines=html-parser.hh -ohtml-parser.cc html-parser.yy
...
comment.o: comment.hh
	g++ --std=c++11 -c comment.cc

document.o: document.hh
	g++ --std=c++11 -c document.cc
